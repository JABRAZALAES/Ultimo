...
<nav class="navbar navbar-expand-lg navbar-dark badge-dark">
  ...
  <div class="container-fluid align-items-stretch">
    ...
    <div class="row mt-3">
      <div class="col-lg-12">
        <div class="caja p-3">
          <h4 style="text-shadow: 2px 2px yellow;">Editor de Noticias de Baloncesto</h4>
          <p>Aquí puedes redactar y editar noticias deportivas relacionadas con el baloncesto.</p>
          <textarea id="contenido" rows="10" class="form-control mt-2" style="resize: vertical;"
            placeholder="Redacta tu noticia aquí"></textarea>
        </div>
        <div class="caja p-3">
          <button id="abrirArchivo" class="btn btn-dark">Abrir Noticia</button>
          <button id="borrarTexto" class="btn btn-danger ml-2">Borrar Texto</button>
          <button id="guardarTexto" class="btn btn-success ml-2">Guardar Noticia</button>
          <input type="file" id="archivo" class="form-control-file mt-2">
        </div>
      </div>
    </div>
